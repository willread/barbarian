...
http.createServer((req,res)=>{
 ...
 const allowed=['studies/backgrounds/mire-v2/','studies/backgrounds/swamp-v1/','asset-sources/art/episodes/mire-effect-v1.png','godot/shaders/mire_sequence.gdshader','godot/assets/enemy-witch-'];

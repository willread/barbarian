...
manifest.menu={};
for(const label of ['BEGIN','OPTIONS','SOUND','DISPLAY','MUSIC: ON','MUSIC: OFF','VOICE: ON','VOICE: OFF',...Array.from({length:101},(_,i)=>`VOLUME: ${i}`),'SOUND: ON','SOUND: OFF','FULLSCREEN: ON','FULLSCREEN: OFF','BACK','RETURN TO BATTLE','QUIT TO TITLE','QUIT','RISE AGAIN','THE BATTLE WAITS.','EVEN HEROES FALL.','A LEGEND RISES.']){

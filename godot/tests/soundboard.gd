...
func check():
	...
	if "--capture" in OS.get_cmdline_user_args():
		...
		board.toggle()
	source.free()
	print("CAIRN_SOUNDBOARD_OK: 124 retained options, 27 active groups, live effect/music replacement and pause restoration")
	quit()

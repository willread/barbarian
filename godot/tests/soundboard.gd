...
func check():
	...
	if "--capture" in OS.get_cmdline_user_args():
		...
		board.toggle()
	source.free()
	print("CAIRN_SOUNDBOARD_OK: 120 retained options, 26 active groups, live effect/music replacement and pause restoration")
	quit()

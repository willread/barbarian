...
export default function Home(){useEffect(()=>{
  ...
  load('/mechanics.js?v=8').then(()=>{if(!disposed)return load('/animation.js?v=8')}).then(()=>{if(!disposed)return load('/hero-rig.js?v=8')}).then(()=>{if(!disposed)return load('/blood.js?v=4')}).then(()=>{if(!disposed)return load('/game.js?v=15')}).catch(()=>{

...
export default function Home(){useEffect(()=>{
  ...
  load('/mechanics.js?v=11').then(()=>{if(!disposed)return load('/animation.js?v=9')}).then(()=>{if(!disposed)return load('/hero-rig.js?v=11')}).then(()=>{if(!disposed)return load('/blood.js?v=4')}).then(()=>{if(!disposed)return load('/events.js?v=2')}).then(()=>{if(!disposed)return load('/enemies.js?v=3')}).then(()=>{if(!disposed)return load('/enemy-art.js?v=1')}).then(()=>{if(!disposed)return load('/enemy-rig.js?v=2')}).then(()=>{if(!disposed)return load('/game.js?v=25')}).catch(()=>{

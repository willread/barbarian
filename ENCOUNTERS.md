...
Minotaur (`legion`) and shield enemy health is scaled by 0.70 after variant health scaling/rounding. `CairnEnemies.HEALTH_SCALE` is the tuning table; other enemies are unchanged.
